...
export default function MainSection({firstName, lastName, email, image}:DoctorType) {
    const listItems = [
        ...
        <div className="bg-[#F8F8F8] rounded-l-[50px] ps-[30px] pt-[30px] overflow-x-hidden w-[100%]">
            ...
            <section className="pt-[30px] flex justify-between flex-wrap w-full">
                <section className="w-[60%] max-[1190px]:w-[90%]">
                    <div>
                        <span><h1 className="text-[22px]">Good morning &nbsp; <span className="text-[#246BFD] text-[26px] font-semibold">Dr {firstName}!</span></h1></span>
                    </div>
                    <section className="bg-gradient-to-tr relative from-[#1A71FF33] to-[#246BFD] w-[100%] p-4 rounded-3xl mt-[30px]">
                                ...
                                <div className="bg-[#FFFFFF55] p-4 rounded-xl">
                                    ...
                                    <div className="flex">
                                        ...
                                        <div className="bg-[#DFFDDD] flex gap-3 rounded-3xl justify-center ml-[1.2rem] p-2 relative left-[15%]">
                                            ...
                                            <Image src={require("../assets/icons/upward.svg")} alt="downward" />
                                        </div>
                                    </div>
                                </div>
                                <div className="bg-[#FFFFFF55] p-4 rounded-xl">
                                    ...
                                    <div className="flex pt-4 items-center">
                                        ...
                                        <div className="bg-[#FBC3C3] flex gap-3 ml-3 rounded-xl items-center ml-[1rem] h-[20px] p-1">
                                            ...
                                            <Image src={require("../assets/icons/downward.svg")} alt="downward" width={15} />
                                        </div>
                                    </div>
                                </div>
                            </section>
                        ...
                        <div className="w-[40%] absolute right-[-10px] bottom-[0] max-[761px]:hidden">
                            <Image src={require("../assets/images/doctor.png")} alt="doctor" width={250} />
                        </div>
                    </section>
                            ...
                            <div>
                                <div className="flex justify-between items-center pt-2">
                                    <div className="flex gap-[30px]">
                                        ...
                                        <div>
                                            <p className="text-[18px] font-semibold">Stacy Mitchell</p>
                                            <p className={`text-[#F62088] text-[14px]`}>Male - 28 Years 3 Months</p>
                                        </div>
                                    </div>
                                    <div>
                                        <div className={`bg-[#F6208815] w-[30px] h-[30px] rounded-full  mr-[10px] flex justify-center items-center p-2`}>
                                            <Image src={require('../assets/icons/threedots.svg')} alt="three dots" className="" />
                                        </div>
                                    </div>
                                </div>
                                <div className="flex gap-[30px] pt-4 text-[12px]">
                                    <div className="flex flex-col gap-[10px] items-center">
                                        <Image src={require('../assets/icons/fever.svg')} alt="fever" className="" />
                                        <p className="font-medium">Fever</p>
                                    </div>
                                    <div className="flex flex-col gap-[10px] items-center">
                                        <Image src={require('../assets/icons/cough.svg')} alt="fever" className="" />
                                        <p className="font-medium">Cough</p>
                                    </div>
                                    <div className="flex flex-col gap-[10px] items-center">
                                        <Image src={require('../assets/icons/heartburn.svg')} alt="fever" className="" />
                                ...
                                <div className="flex flex-col gap-[10px]">
                                    <div className="flex w-full gap-[30px]">
                                        ...
                                        <p className="w-[60%] text-[12px]">Dr Everly on 21 April 2021 Prescription <span className="text-[#1A71FF]">#2J983KT0</span></p>
                                    </div>
                                    <div className="flex w-full gap-[30px]">
                                        <p className="font-medium w-[40%]">Observations</p>
                                        <p className="w-[60%] text-[12px]">High fever and cough at normal hemoglobin levels.</p>
                                    </div>
                                    <div className="flex w-full gap-[30px]">
                                        <p className="font-medium w-[40%]">Prescription</p>
                                        <p className="w-[60%] text-[12px]">Paracetmol - 2 times a day
                ...
                <section id="right-side" className="mr-[30px] p-5 border-black rounded-xl w-[35%] max-[1190px]:w-[60%] max-[700px]:w-[80%]">
                    ...
                    <div className="bg-white rounded-xl shadow-md p-5 mt-5">
                        ...
                        <div>
                            <p className="font-semibold">Equitable medical education with efforts toward real change</p>
                            <div>
                                <Image src={require("../assets/images/article.png")} alt="article" className="w-[100%]" />
                            </div>
                        </div>
                    </div>
                </section>
